...
- docs/business/RAAD_Phase3.5_JT808_Architecture.md
- docs/business/RAAD_Phase3.5_JT1078_Architecture.md

## Core Principles

- Business API must remain independent from device communication.
- Device Services own JT808/JT1078.
- FastAPI exposes business capabilities only.
- No module may bypass domain policies.
- Every architectural decision must trace back to an approved document.
